...
<office:document xmlns:officeooo="http://openoffice.org/2009/office" xmlns:css3t="http://www.w3.org/TR/css3-text/" xmlns:grddl="http://www.w3.org/2003/g/data-view#" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:formx="urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:form:1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rpt="http://openoffice.org/2005/report" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:config="urn:oasis:names:tc:opendocument:xmlns:config:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" xmlns:calcext="urn:org:documentfoundation:names:experimental:calc:xmlns:calcext:1.0" xmlns:tableooo="http://openoffice.org/2009/table" xmlns:drawooo="http://openoffice.org/2010/draw" xmlns:loext="urn:org:documentfoundation:names:experimental:office:xmlns:loext:1.0" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:field="urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:xforms="http://www.w3.org/2002/xforms" office:version="1.3" office:mimetype="application/vnd.oasis.opendocument.text">
 <office:meta><meta:creation-date>2023-11-16T22:47:42.654952965</meta:creation-date><dc:date>2023-11-16T22:55:46.825111201</dc:date><meta:editing-duration>PT8M4S</meta:editing-duration><meta:editing-cycles>3</meta:editing-cycles><meta:generator>LibreOffice/7.3.7.2$Linux_X86_64 LibreOffice_project/30$Build-2</meta:generator><meta:document-statistic meta:table-count="1" meta:image-count="0" meta:object-count="0" meta:page-count="1" meta:paragraph-count="15" meta:word-count="55" meta:character-count="399" meta:non-whitespace-character-count="359"/></office:meta>
 <office:settings>
  <config:config-item-set config:name="ooo:view-settings">
   <config:config-item config:name="ViewAreaTop" config:type="long">0</config:config-item>
   <config:config-item config:name="ViewAreaLeft" config:type="long">0</config:config-item>
   <config:config-item config:name="ViewAreaWidth" config:type="long">22133</config:config-item>
   <config:config-item config:name="ViewAreaHeight" config:type="long">22072</config:config-item>
   <config:config-item config:name="ShowRedlineChanges" config:type="boolean">true</config:config-item>
   <config:config-item config:name="InBrowseMode" config:type="boolean">false</config:config-item>
   <config:config-item-map-indexed config:name="Views">
    <config:config-item-map-entry>
     <config:config-item config:name="ViewId" config:type="string">view2</config:config-item>
     <config:config-item config:name="ViewLeft" config:type="long">2690</config:config-item>
     <config:config-item config:name="ViewTop" config:type="long">6951</config:config-item>
     <config:config-item config:name="VisibleLeft" config:type="long">0</config:config-item>
     <config:config-item config:name="VisibleTop" config:type="long">0</config:config-item>
     <config:config-item config:name="VisibleRight" config:type="long">22132</config:config-item>
     <config:config-item config:name="VisibleBottom" config:type="long">22070</config:config-item>
     <config:config-item config:name="ZoomType" config:type="short">3</config:config-item>
     <config:config-item config:name="ViewLayoutColumns" config:type="short">1</config:config-item>
     <config:config-item config:name="ViewLayoutBookMode" config:type="boolean">false</config:config-item>
     <config:config-item config:name="ZoomFactor" config:type="short">154</config:config-item>
  ...
  <config:config-item-set config:name="ooo:configuration-settings">
   ...
   <config:config-item config:name="Rsid" config:type="int">985123</config:config-item>
   ...
   <config:config-item config:name="RsidRoot" config:type="int">985123</config:config-item>
 ...
 <office:automatic-styles>
  ...
  <style:style style:name="P2" style:family="paragraph" style:parent-style-name="Standard">
   <style:paragraph-properties fo:text-align="justify" style:justify-single-word="false"/>
   <style:text-properties fo:color="#000000" loext:opacity="100%" style:font-name="Arial" fo:language="en" fo:country="GB" fo:font-weight="bold" officeooo:rsid="000f0823" officeooo:paragraph-rsid="000f0823" style:language-asian="es" style:country-asian="ES" style:font-weight-asian="bold" style:font-name-complex="Arial1"/>
  </style:style>
  <style:style style:name="P3" style:family="paragraph" style:parent-style-name="Standard">
   <style:paragraph-properties fo:line-height="0.1665in" fo:text-align="justify" style:justify-single-word="false" fo:orphans="0" fo:widows="0">
    <style:tab-stops>
     <style:tab-stop style:position="0in" style:type="char" style:char=","/>
    </style:tab-stops>
   </style:paragraph-properties>
   <style:text-properties officeooo:paragraph-rsid="000f0823"/>
  </style:style>
  ...
  <style:style style:name="P5" style:family="paragraph" style:parent-style-name="Standard">
   ...
   <style:text-properties style:font-name="Arial" fo:font-size="11pt" fo:language="en" fo:country="GB" officeooo:paragraph-rsid="000f0823" style:font-size-asian="11pt" style:font-name-complex="Arial1" style:font-size-complex="10.5pt"/>
  </style:style>
  <style:style style:name="P6" style:family="paragraph" style:parent-style-name="Standard">
   ...
   <style:text-properties style:font-name="Arial" fo:font-size="11pt" fo:language="en" fo:country="GB" officeooo:rsid="000f0823" officeooo:paragraph-rsid="000f0823" style:font-size-asian="11pt" style:font-name-complex="Arial1" style:font-size-complex="10.5pt"/>
  </style:style>
  <style:style style:name="T1" style:family="text">
   <style:text-properties style:font-name="Arial" fo:font-size="11pt" fo:language="en" fo:country="GB" style:font-size-asian="11pt" style:font-name-complex="Arial1" style:font-size-complex="10.5pt"/>
  </style:style>
  <style:style style:name="T2" style:family="text">
   <style:text-properties style:font-name="Arial" fo:font-size="11pt" fo:language="en" fo:country="GB" officeooo:rsid="0003c75a" style:font-size-asian="11pt" style:font-name-complex="Arial1" style:font-size-complex="10.5pt"/>
  </style:style>
  <style:style style:name="T3" style:family="text">
   <style:text-properties style:font-name="Arial" fo:font-size="11pt" fo:language="en" fo:country="GB" officeooo:rsid="0003e298" style:font-size-asian="11pt" style:font-name-complex="Arial1" style:font-size-complex="10.5pt"/>
  </style:style>
  <style:style style:name="T4" style:family="text">
   <style:text-properties style:font-name="Arial" fo:font-size="11pt" fo:language="en" fo:country="GB" officeooo:rsid="000f0823" style:font-size-asian="11pt" style:font-name-complex="Arial1" style:font-size-complex="10.5pt"/>
  </style:style>
  <style:style style:name="T5" style:family="text">
   <style:text-properties style:font-name="Arial" fo:font-size="11pt" fo:language="en" fo:country="GB" fo:font-weight="bold" style:font-size-asian="11pt" style:font-weight-asian="bold" style:font-name-complex="Arial1" style:font-size-complex="10.5pt" style:font-weight-complex="bold"/>
  </style:style>
  <style:style style:name="T6" style:family="text">
   <style:text-properties style:font-name="Arial" fo:font-size="11pt" fo:language="en" fo:country="GB" fo:font-weight="bold" officeooo:rsid="0003c75a" style:font-size-asian="11pt" style:font-weight-asian="bold" style:font-name-complex="Arial1" style:font-size-complex="10.5pt" style:font-weight-complex="bold"/>
  </style:style>
   ...
   <table:table table:name="Table7" table:style-name="Table7">
    ...
    <table:table-row table:style-name="Table7.1">
     <table:table-cell table:style-name="Table7.A1" table:number-columns-spanned="4" office:value-type="string">
      <text:p text:style-name="P4"><text:span text:style-name="T1">Authors: </text:span>  {authors} </text:p>
     </table:table-cell>
    ...
    <table:table-row table:style-name="Table7.1">
     <table:table-cell table:style-name="Table7.A1" table:number-columns-spanned="4" office:value-type="string">
      <text:p text:style-name="P4"><text:span text:style-name="T1">Name of journal: </text:span><text:span text:style-name="T5">{journal} </text:span></text:p>
     </table:table-cell>
     <table:covered-table-cell/>
     <table:covered-table-cell/>
     <table:covered-table-cell/>
    ...
    <table:table-row table:style-name="Table7.1">
     <table:table-cell table:style-name="Table7.A1" office:value-type="string">
      <text:p text:style-name="P3"><text:span text:style-name="T1">Volume: </text:span><text:span text:style-name="T4">{volume}</text:span></text:p>
     </table:table-cell>
     <table:table-cell table:style-name="Table7.A1" office:value-type="string">
      <text:p text:style-name="P3"><text:span text:style-name="T1">Initial pag: </text:span><text:span text:style-name="T4">{initial_pag}</text:span></text:p>
     </table:table-cell>
     <table:table-cell table:style-name="Table7.A1" office:value-type="string">
      <text:p text:style-name="P3"><text:span text:style-name="T1">Final pag: </text:span><text:span text:style-name="T4">{final_pag}</text:span></text:p>
     </table:table-cell>
     <table:table-cell table:style-name="Table7.A1" office:value-type="string">
      <text:p text:style-name="P3"><text:span text:style-name="T1">Year: </text:span><text:span text:style-name="T2">{year} </text:span></text:p>
     </table:table-cell>
    </table:table-row>
    <table:table-row table:style-name="Table7.1">
     <table:table-cell table:style-name="Table7.A1" office:value-type="string">
     ...
     <table:table-cell table:style-name="Table7.A1" office:value-type="string">
      <text:p text:style-name="P3"><text:span text:style-name="T1">Publication place:</text:span></text:p>
     </table:table-cell>
     <table:table-cell table:style-name="Table7.A1" office:value-type="string">
      <text:p text:style-name="P6">{place}</text:p>
     </table:table-cell>
    </table:table-row>
    <table:table-row table:style-name="Table7.1">
     <table:table-cell table:style-name="Table7.A1" office:value-type="string">
      <text:p text:style-name="P3"><text:span text:style-name="T1">Quality indicators:</text:span></text:p>
     </table:table-cell>
     <table:table-cell table:style-name="Table7.A1" table:number-columns-spanned="3" office:value-type="string">
      <text:p text:style-name="P3"><text:span text:style-name="T1">Data base: </text:span><text:span text:style-name="T4">{database}</text:span></text:p>
     </table:table-cell>
     <table:covered-table-cell/>
     <table:covered-table-cell/>
    </table:table-row>
...
def write_citations(number=None):
    if number is None:
        ...
        return citations.format(citations=number)


def write_table(list_index=0,
